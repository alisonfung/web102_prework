...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++){
        ...
        gameDiv.innerHTML = `<h2>${games[i].name}<h2> 
...
const displayStr = `A total of $${totalAmount.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, 
                    ${numOfUnfundedGames} games ${numOfUnfundedGames == 1 ? "remains" : "remain"} unfunded. We need your help to fund
                    these amazing games!`;
...
descriptionContainer.append(gameParagraph);
...
let [firstGame, secondGame, ...otherGames] = GAMES_JSON
